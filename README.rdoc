...
Physical (where will the user be using the application?)
---------------------------------------------------------
* at home
* at the office
* while traveling
...
Media (what device(s) can the application be used on?)
------------------------------------------------------
* laptop/desktop

Modal (what will the users state of mind be when using the application?)
------------------------------------------------------------------------
...
Goals (what is the main goal of the application?)
-------------------------------------------------
Productivity application -> task-based app

Needs (what needs does the application fill?)
---------------------------------------------
